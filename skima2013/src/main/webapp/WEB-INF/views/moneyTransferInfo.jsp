...
<div class="row" style="margin-top: 20px;">
	...
	<table class="table table-bordered">
		...
		<tbody>
			<tr>
				<td style="padding-left: 40px; border-bottom: 0px;">SKIMA 2013 Registration Fee - ${registrator.registrationInfo.registrationItemStringNoFee}</td>
...
<div class="row"  style="margin-top: 20px; margin-bottom: 40px;">
	...
	<form:form class="form-horizontal" action="${flowExecutionUrl}" method="POST" commandName="registrator">
		<div class="span12">
			...
			<button type="submit" class="btn" name="_eventId_complete">Registration Complete, Back to SKIMA2013 Web Page</button>		
		</div>   	
	</form:form>
